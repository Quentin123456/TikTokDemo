...
extension AwemeList {
    ...
    func with(
        ...
        return AwemeList(
            ...
            adLinkType: adLinkType ?? self.adLinkType,
...
struct AwemeListAuthor: Codable {
    ...
    let youtubeExpireTime: Int?
    let roomID: Double?
    let liveVerify, authorityStatus: Int?
...
struct AuthorShareInfo: Codable {
    let shareURL, shareWeiboDesc, shareDesc, shareTitle: String?
...
struct ChaList: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case hashtagProfile = "hashtag_profile"
...
extension ChaList {
    ...
    func with(
        ...
        return ChaList(
            ...
            hashtagProfile: hashtagProfile ?? self.hashtagProfile,
...
struct Music: Codable {
    ...
    let isCommerceMusic, isOriginalSound: Bool?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case isCommerceMusic = "is_commerce_music"
        case isOriginalSound = "is_original_sound"
    }
}
...
extension Music {
    ...
    func with(
        ...
        isCommerceMusic: Bool?? = nil,
        isOriginalSound: Bool?? = nil
    ) -> Music {
        return Music(
            id: id ?? self.id,
            ...
            isCommerceMusic: isCommerceMusic ?? self.isCommerceMusic,
            isOriginalSound: isOriginalSound ?? self.isOriginalSound
        )
    }
...
struct Statistics: Codable {
    ...
    let shareCount, forwardCount, loseCount, loseCommentCount: Int?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case loseCommentCount = "lose_comment_count"
    }
}
...
extension Statistics {
    ...
    func with(
        ...
        return Statistics(
            ...
            loseCount: loseCount ?? self.loseCount,
            loseCommentCount: loseCommentCount ?? self.loseCommentCount
        )
    }
...
struct Video: Codable {
    ...
    let uiAlikeDownloadAddr: ArakGroundhog?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case uiAlikeDownloadAddr = "ui_alike_download_addr"
    }
}
...
extension Video {
    ...
    func with(
        ...
        uiAlikeDownloadAddr: ArakGroundhog?? = nil
    ) -> Video {
        return Video(
            ...
            uiAlikeDownloadAddr: uiAlikeDownloadAddr ?? self.uiAlikeDownloadAddr
        )
    }
